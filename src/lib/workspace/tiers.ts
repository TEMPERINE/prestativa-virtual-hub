...
export const TIERS: Record<WorkspaceTier, TierCapabilities> = {
  1: {
    ...
    shortLabel: "Nível 1",
    description:
      "Para 1 a 2 pessoas. Reuniões com vídeo, áudio e compartilhamento de tela liberadas. Sem gravação, sem teleporte. Personagem fixo (afro/loira).",
    maxMembers: 2,
  ...
  2: {
    ...
    shortLabel: "Nível 2",
    description:
      "Para até 5 pessoas. Todas as funções liberadas (reuniões, gravação, IA, temas customizados). Única restrição é o limite de membros.",
    maxMembers: 5,
