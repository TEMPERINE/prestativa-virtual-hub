  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-background via-accent/30 to-background">
      <div className="max-w-md text-center glass-panel rounded-2xl p-10">
        ...
        <h1 className="text-xl font-semibold mb-2">Aguardando convite</h1>
        <p className="text-sm text-muted-foreground mb-6">
          Sua conta está ativa, mas você ainda não foi convidado para nenhum espaço de trabalho.
          Peça um link de convite para a administração.
        </p>
